...
Public Class FuncoesUteisDAO
    ...
    Shared Sub ReabastecerCNPJS(context As CrawlerContext)
        ...
        If listaDeCNPJ.Where(Function(cnpj) cnpj.ENRIQUECIDO = Nothing).Count < 50 Then
            ...
            Dim ListaReposicao As List(Of CNPJ) = New List(Of CNPJ)
            'context.CNPJS.Where(Function(cnpj) cnpj.ENRIQUECIDO = Nothing And cnpj.UF = UF) _
            '.OrderBy(Function(cnpj) cnpj.CNPJS).Skip(200).Take(CNPJSCONSULTADOS.Length).ToList
