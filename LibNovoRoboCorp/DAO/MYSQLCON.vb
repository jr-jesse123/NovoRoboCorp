...
Public Class Mysqlcoon
    ...
    Public Sub New(Optional Servidor As String = "novocorpscrapp.mysql.dbaas.com.br",
                       Optional vUser As String = "novocorpscrapp",
                       Optional vPassword As String = "D4Consultoria",
                       Optional vDatabase As String = "novocorpscrapp")
