...
Namespace Migrations
    ...
    Public NotInheritable Partial Class nvoocampPulico
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(nvoocampPulico))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201909011142241_nvoocampPulico"
            End Get
        End Property
