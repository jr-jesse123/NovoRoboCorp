...
Namespace Migrations
    ...
    Public NotInheritable Partial Class adicaoNovoCampo
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(adicaoNovoCampo))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201909011140046_adicaoNovoCampo"
            End Get
        End Property
